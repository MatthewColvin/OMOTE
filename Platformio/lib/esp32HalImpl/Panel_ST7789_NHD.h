...
//----------------------------------------------------------------------------
  ...
  struct Panel_ST7789_NHD  : public Panel_LCD
  {
    Panel_ST7789_NHD(void)
    {
  ...
  protected:
    ...
    const uint8_t* getInitCommands(uint8_t listno) const override {
      static constexpr uint8_t list0[] = {
          ...
          CMD_GCTRL  , 1, 0x35,
          CMD_VCOMS  , 1, 0x2B,
          CMD_LCMCTRL, 1, 0x0c,//Datasheet specifies 0x2C but seems to swap R and B in colour order
          CMD_VDVVRHEN,2, 0x01, 0xFF,
          CMD_VRHS   , 1, 0x11,      // voltage VRHS
          CMD_VDVSET , 1, 0x20,
          ...
          CMD_PVGAMCTRL,14, 0xd0,0x00,0x05,0x0e,
                             ...
                             0x47,0x09,0x15,0x12,
                             0x16,0x19,
          CMD_NVGAMCTRL,14, 0xd0,0x00,0x05,0x0d,
                             0x0c,0x06,0x2d,0x44,
                             0x40,0x0e,0x1c,0x18,
                             0x16,0x19,
